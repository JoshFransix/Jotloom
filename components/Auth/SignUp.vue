    ...
    <div class="tw-h-full tw-w-full">
      ...
      >
        <div class="tw-text-center tw-mb-12">
          <h3
            class="tw-text-white tw-mb-6 tw-text-2xl tw-font-semibold md-lg:tw-text-xl"
          >
            Hello there,
          </h3>
          <span class="tw-text-[#ddd] sm:tw-text-sm"
            >Please enter your details to create an account.</span
          >
        </div>
        ...
        <v-btn
          ...
          :loading="isLoading"
          ><span>Create Account</span></v-btn
        >
      </v-form>
      <h2 class="tw-text-sm tw-text-[#a1a1a1] tw-mt-4">
        ...
        <span
          @click="$emit('toLogin')"
          class="tw-text-brand-primary tw-cursor-pointer"
          >Login?</span
        >
      </h2>
      <div class="tw-mt-8">
