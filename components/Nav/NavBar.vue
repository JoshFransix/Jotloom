<template>
  <div>
    <v-navigation-drawer
      ...
      fixed
      temporary
      class="mobileNav h-auto px-4 py-5"
    >
      <div>
        ...
        <div class="tw-mt-10 tw-grid tw-grid-cols-1 tw-gap-y-3">
          ...
          <nuxt-link to="/#features"
            ><v-icon color="primary" class="mr-2">mdi-hand-heart-outline</v-icon
            >Features</nuxt-link
          >
          <nuxt-link to="/#about"
            ><v-icon color="primary" class="mr-2">mdi-comment-account</v-icon
            >About Us</nuxt-link
          >
          <nuxt-link to="/#contact"
            ><v-icon color="primary" class="mr-2">mdi-phone-plus-outline</v-icon
        ...
        <div class="tw-mt-12 tw-pb-6">
          <div v-if="!user" class="tw-grid tw-grid-cols-1 tw-gap-y-3">
            <nuxt-link to="/auth?login"
              ><v-icon color="primary" class="mr-2">mdi-login</v-icon>Log
              In</nuxt-link
            >
            <nuxt-link
              class="signUp tw-px-4 tw-py-2 tw-rounded-md"
              to="/auth?signup"
          ...
          <div v-else>
            <div
              ...
              to="/auth?signup"
            >
              <v-icon color="primary" class="mr-2">mdi-logout-variant</v-icon
              >Logout
            </div>
          </div>
        </div>
    ...
    >
      <div
        class="tw-backdrop-blur-sm tw-w-10/12 tw-mx-auto tw-flex tw-justify-between tw-items-center"
      >
        <nuxt-link to="/">
          <div class="logo tw-font-bold tw-text-xl">
            <h1>
        ...
        <div>
          <div v-if="!user" class="tw-flex tw-items-center md:tw-hidden">
            ...
            <nuxt-link to="/auth?signup">
              <div
                class="tw-text-white tw-px-4 tw-py-2 tw-rounded-full tw-bg-brand-primary"
              >
                <h1>Sign Up</h1>
              </div>
            </nuxt-link>
