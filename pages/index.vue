<template>
  <div class="tw-overflow-x-hidden">
    ...
    <v-main>
      ...
      <section
        id="home"
        class="tw-pt-32 tw-h-screen sm:tw-h-[80vh] sm:tw-pt-44"
      >
        <div
          class="tw-flex tw-text-white tw-flex-col tw-items-center tw-justify-center"
        >
          <h1
            data-aos="fade-up"
            data-aos-duration="600"
            data-aos-easing="ease-in-out"
            class="tw-text-3xl tw-leading-[1.4rem] tw-text-center tw-font-bold md:tw-text-xl"
          >
            Sculpting the future<span class="tw-text-brand-primary">
              Jotspace</span
            >
          </h1>
          <p
          ...
          >
            ...
            <span class="tw-text-brand-primary">.</span>
          </p>
          <div class="">
            <landing-image
              data-aos="zoom-in-up"
              ...
              data-aos-easing="ease-in-out"
              class="tw-w-[500px] tw-h-[500px] sm:tw-w-[400px] sm:tw-h-[400px]"
            ></landing-image>
          </div>
        </div>
      </section>
      ...
      <section id="about" class="tw-pt-[10rem]">
        ...
        >
          ...
          >
            <h3 class="tw-text-brand-primary tw-text-sm tw-mb-2 fira">
              Our Mission
            </h3>
            <h1 class="tw-text-3xl md:tw-text-xl">
              <span class="tw-text-brand-primary">J</span>otloom's<span
                class="tw-text-brand-primary"
              >
                M</span
              >ission
            </h1>
            <p class="tw-mt-12 sm:tw-text-sm sm:tw-mt-8">
              Welcome to Jotloom, where simplicity meets productivity. We
              understand the importance of capturing ideas effortlessly, which
              is why we've created a seamless note-taking experience tailored
              just for you.
            </p>
          </div>
          <div
      ...
      <section id="features" class="tw-mt-[8rem]">
        <div class="tw-w-11/12 tw-mx-auto tw-pt-[6rem] tw-mb-8 tw-text-center">
          <h3
            class="tw-text-brand-primary tw-text-sm tw-mb-2 fira tw-text-center"
          >
            Features
          </h3>
          <h1 class="tw-text-3xl tw-text-white md:tw-text-xl">
            <span class="tw-text-brand-primary">J</span>otloom's<span
              class="tw-text-brand-primary"
            >
              F</span
          ...
          <div
            class="grid tw-mt-8 tw-grid tw-grid-cols-3 tw-gap-4 tw-text-white"
          >
            <div
            ...
            >
              <cross-platform
                v-if="i == 0"
                class="tw-mx-auto tw-w-[250px] tw-mb-14"
              />
              <password-protection
                v-if="i == 1"
                class="tw-mx-auto tw-w-[200px]"
              />
              <voice-translation
                v-if="i == 2"
                class="tw-mx-auto tw-w-[200px]"
              ...
              <p class="tw-text-[#ccc] tw-leading-[1.7rem] tw-text-sm">
                {{ item.text }}
              </p>
            </div>
          </div>
      ...
      <section id="contact" class="tw-pt-[10rem] tw-pb-[4rem]">
        ...
        >
          ...
          >
            ...
            <h1 class="tw-mb-8 tw-text-2xl tw-text-white md:tw-text-xl">
              <span class="tw-text-brand-primary">L</span>eave a<span
                class="tw-text-brand-primary"
              >
                M</span
              >essage
      ...
      <footer id="footer">
        ...
        >
          <div>
            <a target="_blank" href="https://github.com/joshfransix"
              ><v-btn icon color="primary"
                ><v-icon>mdi-github</v-icon></v-btn
              ></a
            >

            <a target="_blank" href="https://linkedin.com/in/joshfransix"
              ><v-btn class="mx-6" icon color="primary"
            ...
            <a target="_blank" href="https://joshfransix.netlify.app">
              <v-btn icon color="primary"
                ><span class="tw-font-bold">JF</span></v-btn
              >
            </a>
          </div>
          ...
          <div class="tw-mt-4 tw-mb-5 tw-text-sm">
            <a
              class="tw-text-white tw-transition-all hover:tw-text-brand-primary"
              href="https://github.com/joshfransix"
              >Built with 🚀 by Joshua Fransix</a
            >
          </div>
